...
with(dataWithinPeriod, {plot(Sub_metering_1~DateTime, type="l", ylab="Global Active Power (kilowatts)", xlab="");lines(Sub_metering_2~DateTime,col='Red');lines(Sub_metering_3~DateTime,col='Blue')})
